<section class="h-[80vh] max-w-[100vh] md:max-w-[100vw] w-full bg-cover" style="background-image: url({{$bg}});">
    <div class="container w-full h-full flex items-center justify-between ">
        <div class="w-full sm:w-3/4 md:w-full h-[90%] flex flex-col items-center sm:items-start justify-center gap-3 sm:gap-7 px-2 sm:px-0">
            <div class="text-[42px] flex flex-col items-center text-center sm:items-start sm:text-left sm:text-[64px] sm:leading-[80px]">
                <h1 class="font-custom text-primary">
                    <p>Our <span class="text-accent font-semibold">HealthCare</span> <br>Solutions Meet <br><span class="text-accent font-semibold">Every</span> Need</p> 
                </h1>
            ...
            <div class="bg-white bg-opacity-50 p-4 pl-0 grid grid-cols-3 gap-5 rounded-[2px]">
                <div class="flex flex-col justify-center items-center">
                    <h2 class="text-3xl font-semibold text-primary">100+</h2>
                    <p class="text-[10px] text-secondary">Expert Doctor</p>
                </div>
                <div class="flex flex-col justify-center items-center">
                    <h2 class="text-3xl font-semibold text-primary">1,000+</h2>
                    <p class="text-[10px] text-secondary">Patients Served</p>
                </div>
                <div class="flex flex-col justify-center items-center">
                    <h2 class="text-3xl font-semibold text-primary">72%</h2>
